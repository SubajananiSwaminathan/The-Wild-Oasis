...
import { subtractDates } from "../utilities/helpers";
...
async function createBookings() {
  ...
  const finalBookings = bookings.map((booking) => {
    ...
    const no_of_nights = subtractDates(booking.end_date, booking.start_date);
    const cabin_price = no_of_nights * (cabin.regular_price - cabin.discount);
    const extras_price = booking.has_breakfast
      ? no_of_nights * 15 * booking.no_of_guests
